...
export const Book = () => {
    ...
    const addBook = async () => {
        ...
        isBookExist = isExist.data.success;
        // setBookExist(isBookExist);
        ...
        if (isBookExist) {
            ...
            if (addbook.status == 201) {
                ...
                alert("Isbn exist, please enter correct isbn.");
            }
        }
        // console.log(formData);
        // setOpen(false);
        ...
        <Layout>
            <div className="card shadow">
                <div className="card-header py-3">
                    <p className="text-primary m-0 fw-bold text-uppercase">Book</p>
                </div>
